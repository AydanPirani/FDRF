...
#define ID_T size_t
#define ID_ENTRY std::pair<ID_T, Resource>
#define SHARE_ENTRY std::pair<float, ID_T>
#define RESOURCE_T long long
...
struct Resource {
    ...
    Resource(): _cpu(0), _ram(0) { }

    Resource(RESOURCE_T cpu, RESOURCE_T ram): _cpu(cpu), _ram(ram) { }
